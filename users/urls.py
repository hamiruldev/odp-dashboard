...
urlpatterns = [
    ...
    path('reset/<str:username>', CustomResetPassword.as_view(), name="reset_password"),
    path('set-password/<str:temPass>/<str:username>', CustomNewPassword.as_view(), name="set_password"),
